        ...
        <div data-v-a9660e98="" class="c-tc item van-row">
            ...
            <div data-v-a9660e98="" class="van-col van-col--5">
                <div data-v-a9660e98="" class="c-tc goItem">
                    <span data-v-a9660e98=""> ${(total < 23) ? "Small" : "Big"} </span>
                </div>
            </div>
            <div data-v-a9660e98="" class="van-col van-col--5">
                <div data-v-a9660e98="" class="c-tc goItem">
...
function messNewJoin2(datas) {
    ...
    datas.map((data) => {
        ...
        <div class="direct-chat-text" style="background-color: #1eb93d"> Tham gia ${(isNumber(list_join2)) ? "( " + list_join2 + " )" : (list_join2 == 'b') ? 'Big' : (list_join2 == 's') ? 'Small' : (list_join2 == 'c') ? 'Even' : 'odd'} ${money} </div>
        `; 
    });
...
function messNewJoin(data) {
    ...
    result += `
        ...
        Tham gia ${(isNumber(list_join2)) ? "( " + list_join2 + " )" : (list_join2 == 'b') ? 'Big' : (list_join2 == 's') ? 'Small' : (list_join2 == 'c') ? 'Even' : 'Odd'} ${money}
        </div>
        `;
