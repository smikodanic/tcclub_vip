    ...
    datas.map((data) => {
        if (data.typeGame == 'total') {
            result += `
                ...
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join Total(${data.bet}) with the Amount of money ${data.money}</div>
            `; 
        }
        if (data.typeGame == 'three-same') {
            result += `
                ...
                <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join 3 same numbers(${data.bet}) with the Amount of money ${data.money}</div>
            `; 
        }
        ...
        if (data.typeGame == 'two-same') {
            result += `
                ...
                <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join 2 same numbers(${data.bet}) with the Amount of money ${data.money}</div>
            `; 
        }
        if (data.typeGame == 'unlike') {
            result += `
                ...
                <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join another number(${data.bet}) with the Amount of money ${data.money}</div>
            `; 
        }
    });
...
function messNewJoin(data) {
    ...
    if (typeGame == 'total') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join Total(${data.listJoin}) with the Amount of money ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
    if (typeGame == 'three-same') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join 3 same numbers(${data.listJoin}) with the Amount of money ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
    ...
    if (typeGame == 'two-same') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join 2 same numbers(${data.listJoin}) with the Amount of money ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
    if (typeGame == 'unlike') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join another number (${data.listJoin}) with the Amount of money ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
